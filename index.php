...
if ($sql = mysqli_query($koneksi, $query)) {
    ...
    $sesi_nama  = isset($users['name']) ? $users['name'] : '';
            ...
            <header class="mb-5">
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUser Dropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="user-dropdown-status text-sm text-muted"><?= $sesi_email; ?></p>
                                    </div>
                                </a>
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            <li class="menu-item">
                                <a href="?page=dashboard&status=semua&priority=semua" class='menu-link'>
